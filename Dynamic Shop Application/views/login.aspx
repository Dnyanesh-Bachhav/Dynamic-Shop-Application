<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="Dynamic_Shop_Application.views.login" %>
...
<head runat="server">
  ...
  <body>
    ...
    <div class="bg-img">
        ...
        <ul>
            <li><a class=" text-decoration-none btn btn-home"   href="admin_login.aspx">Admin Login</a></li>
            <li><a href="login.aspx" class="text-decoration-none btn btn-logout active">Guest Login</a></li>
        </ul>
        </nav>
